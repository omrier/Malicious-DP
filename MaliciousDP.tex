...
\begin{enumerate}
    ...
    $$R_{T_{\approx f}} = \{(x,{\cal D}) | x\in X^n \wedge \Pr_{y\sim {\cal D}} \left[\forall i\in [n]\;|y_i-f(x)_i|\leq \alpha\right] \geq 1-\beta\}.$$
...
\subsubsection{$S$-security}

\subsubsection{Simulation of augmented semi-honest executions}
